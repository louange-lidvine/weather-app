    ...
    return (
        <div className="w-[80%] h-full capitalize md:no flex flex-col text-white p-7 pt-1m-auto md:m-none">
            ...
            <div>
                ...
                >
                    <path
                        d="M0.5 32.5C0.5 32.5 21.3192 11.4447 38 12C52.0524 12.4678 56.1097 30.6796 70 28.5C79.3652 27.0304 81.3114 17.8316 90.5 15.5C103.455 12.2128 110.803 24.6115 124 22.5C138.921 20.1126 141.471 3.07338 156.5 1.5C175.627 -0.502358 180.272 25.1537 199.5 25.5C216.291 25.8024 222.237 7.4879 239 8.5C252.259 9.30056 256.778 21.2234 270 22.5C284.95 23.9435 295.036 21.0813 307 12"
                        stroke="#E69D5A"
                    />
                </svg>
